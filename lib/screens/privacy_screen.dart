    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Config.vGap10,
          const Text(
              'At Skribla, owned by Ifeanyi Onuoha, we value your privacy. This Privacy Policy ("Policy") describes how we collect, use, and share your personal information when you use Skribla application ("Service"). By using our Service, you agree to the terms of this Policy.'),
          Config.vGap15,
